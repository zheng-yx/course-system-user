...
export function validateFileVideo(video) {
  if (video === null || video === '') return false
  return ['mp4'].indexOf(video.toLowerCase()) !== -1
}

export function validateFilePdf(pdf) {
  if (pdf === null || pdf === '') return false
  return ['pdf'].indexOf(pdf.toLowerCase()) !== -1
}
